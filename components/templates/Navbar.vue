        ...
        >
          <li>
            <div class="relative inline-block w-full text-gray-700">
              <select
                ...
                v-model="$i18n.locale"
                @change="af_switchLang($i18n.locale)"
              >
                <option
          ...
          >
            ...
            >
              ...
              <p class="ml-2 lg:hidden"> {{ $t("night_mode") }}</p>
            </div>
            <div
              v-else
            ...
            >
              ...
              <p class="ml-2 lg:hidden"> {{ $t("day_mode") }}</p>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    af_switchLang: function (code) {
        if (code === "en") this.$router.push("/"+code)
