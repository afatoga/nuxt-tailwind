    ...
    >
      <div class="px-2 md:px-0">
        ...
        <!-- <div
          ...
          "
        >
          Používáme WordPress, React, Node.js, Postgres nebo&nbsp;MySQL,
          Amazon&nbsp;Web&nbsp;Services, WooCommerce a&nbsp;jiné technologie.
        </div> -->
      </div>
      <picture class="hidden md:block md:ml-12 md:mr-0 lg:mx-1">
        <img
